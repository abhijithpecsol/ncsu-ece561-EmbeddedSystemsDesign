...
const REGION_T RegionTable[] = {
	...
	{0x00000c69, 0x00000cb4, "get_accel_from_data"}, // 39
	{0x00000cc5, 0x00000ce0, "sqrt_approx"}, // 40
	{0x00000ce1, 0x00000d64, "atan2_approx"}, // 41
	{0x00000d65, 0x00000dca, "cos_approx"}, // 42
	{0x00000dcb, 0x00000e32, "sin_approx"}, // 43
	{0x00000e61, 0x00000fe4, "get_v2xe_data"}, // 44
	{0x00000fe5, 0x00000fe6, "calibrate_v2xe"}, // 45
	{0x00000fe7, 0x00001040, "calc_raw_heading"}, // 46
	{0x00001041, 0x000010fa, "calc_tilt_comp_heading"}, // 47
	{0x00001121, 0x00001174, "init_triggers"}, // 48
	{0x00001181, 0x000011ac, "__aeabi_uidivmod"}, // 49
	{0x000011ad, 0x0000124e, "__aeabi_fadd"}, // 50
	{0x0000124f, 0x00001256, "__aeabi_fsub"}, // 51
	{0x00001257, 0x0000125e, "__aeabi_frsub"}, // 52
	{0x0000125f, 0x000012d8, "__aeabi_fmul"}, // 53
	{0x000012d9, 0x00001354, "__aeabi_fdiv"}, // 54
	{0x00001355, 0x0000136c, "__ARM_scalbnf"}, // 55
	{0x0000136d, 0x00001382, "__aeabi_i2f"}, // 56
	{0x00001383, 0x00001392, "_float_round"}, // 57
	{0x00001393, 0x00001404, "_float_epilogue"}, // 58
	{0x00001405, 0x00001420, "__scatterload"}, // 59
	{0x00001429, 0x00001436, "__scatterload_zeroinit"}, // 60
}; 
const unsigned NumProfileRegions=61;
volatile unsigned RegionCount[61];
