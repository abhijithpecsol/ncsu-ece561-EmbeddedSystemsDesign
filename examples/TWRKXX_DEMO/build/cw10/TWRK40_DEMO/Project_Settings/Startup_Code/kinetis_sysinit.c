...
void __init_hardware()
{
    ...
    *(volatile unsigned short *)KINETIS_WDOG_STCTRLH_ADDR = KINETIS_WDOG_DISABLED_CTRL;
    ...
    // that will produce a 2MHz reference clock to the PLL.
      MCG_C5 = MCG_C5_PLLSTEN_MASK | MCG_C5_PRDIV(REF_CLK); // Set PLL ref divider to match the crystal used + Enable PPL in Normal Stop mode
    #endif
