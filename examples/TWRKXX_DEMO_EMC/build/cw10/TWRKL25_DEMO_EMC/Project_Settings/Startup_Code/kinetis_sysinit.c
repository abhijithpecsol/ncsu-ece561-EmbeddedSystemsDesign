...
__attribute__ ((section (".vectortable"))) const tVectorTable __vector_table = { /* Interrupt vector table */
  ...
  (tIsrFunc)&Default_Handler,          /* 0x04  0x00000010   -   ivINT_Reserved4               unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x05  0x00000014   -   ivINT_Reserved5               unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x06  0x00000018   -   ivINT_Reserved6               unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x07  0x0000001C   -   ivINT_Reserved7               unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x08  0x00000020   -   ivINT_Reserved8               unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x09  0x00000024   -   ivINT_Reserved9               unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x0A  0x00000028   -   ivINT_Reserved10              unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x0B  0x0000002C   -   ivINT_SVCall                  unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x0C  0x00000030   -   ivINT_Reserved12              unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x0D  0x00000034   -   ivINT_Reserved13              unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x0E  0x00000038   -   ivINT_PendableSrvReq          unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x0F  0x0000003C   -   ivINT_SysTick                 unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x10  0x00000040   -   ivINT_DMA0                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x11  0x00000044   -   ivINT_DMA1                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x12  0x00000048   -   ivINT_DMA2                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x13  0x0000004C   -   ivINT_DMA3                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x14  0x00000050   -   ivINT_Reserved20              unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x15  0x00000054   -   ivINT_FTFA                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x16  0x00000058   -   ivINT_LVD_LVW                 unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x17  0x0000005C   -   ivINT_LLW                     unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x18  0x00000060   -   ivINT_I2C0                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x19  0x00000064   -   ivINT_I2C1                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x1A  0x00000068   -   ivINT_SPI0                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x1B  0x0000006C   -   ivINT_SPI1                    unused by PE */
  (tIsrFunc)&FMSTR_Isr,          	   /* 0x1C  0x00000070   -   ivINT_UART0                   unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x1D  0x00000074   -   ivINT_UART1                   unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x1E  0x00000078   -   ivINT_UART2                   unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x1F  0x0000007C   -   ivINT_ADC0                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x20  0x00000080   -   ivINT_CMP0                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x21  0x00000084   -   ivINT_TPM0                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x22  0x00000088   -   ivINT_TPM1                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x23  0x0000008C   -   ivINT_TPM2                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x24  0x00000090   -   ivINT_RTC                     unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x25  0x00000094   -   ivINT_RTC_Seconds             unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x26  0x00000098   -   ivINT_PIT                     unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x27  0x0000009C   -   ivINT_Reserved39              unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x28  0x000000A0   -   ivINT_USB0                    unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x29  0x000000A4   -   ivINT_DAC0                    unused by PE */
  (tIsrFunc)&TSS_TSI0Isr,              /* 0x2A  0x000000A8   -   ivINT_TSI0                    used by PE */
  (tIsrFunc)&Default_Handler,          /* 0x2B  0x000000AC   -   ivINT_MCG                     unused by PE */
  (tIsrFunc)&Default_Handler,         		   /* 0x2C  0x000000B0   -   ivINT_LPTimer                 unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x2D  0x000000B4   -   ivINT_Reserved45              unused by PE */
  (tIsrFunc)&Default_Handler,          /* 0x2E  0x000000B8   -   ivINT_PORTA                   unused by PE */
  (tIsrFunc)&Default_Handler           /* 0x2F  0x000000BC   -   ivINT_PORTD                   unused by PE */
  }
};
...
void __attribute__ ((constructor)) __init_hardware()
{
    ...
    unsigned char mcgout_select=MCGOUT;
    int error_code;
