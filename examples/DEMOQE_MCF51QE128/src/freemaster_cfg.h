...
/*****************************************************************************
* Select communication interface (SCI)
******************************************************************************/

#define FMSTR_SCI_BASE         0xffff8020 // SCI register base on ColdFire V1 QE
#define FMSTR_SCI_RX_INTERRUPT 77  // SCI RX and SCI TX interrupt numbers
#define FMSTR_SCI_TX_INTERRUPT 78  // (use to automatically set INT handlers)
...
#define FMSTR_REC_BUFF_SIZE   20	// built-in buffer size
