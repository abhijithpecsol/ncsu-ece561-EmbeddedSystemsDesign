...
#define FMSTR_SCI_BASE         0xffff8038 // SCI register base on ColdFire V1 AC256
#define FMSTR_SCI_RX_INTERRUPT 83  // SCI RX and SCI TX interrupt numbers
#define FMSTR_SCI_TX_INTERRUPT 84  // (use to automatically set INT handlers)

#define FMSTR_CAN_BASE         0xffff9880 /* MSCAN register base on ColdFire V1 AC256 */
#define FMSTR_CAN_RX_INTERRUPT 116  /* MCF51xx-only: MSCAN RX and MSCAN TX interrupt numbers */
#define FMSTR_CAN_TX_INTERRUPT 117  /*            (or use VECTOR statements in PRM file) */

#define FMSTR_USE_SCI       0      /* To selecet SCI communication interface */
#define FMSTR_USE_PDBDM     1      /* To selecet BDM communication interface */
...
#define FMSTR_APPCMD_BUFF_SIZE 16	// App.Command data buffer size
...
#define FMSTR_REC_BUFF_SIZE   1500	// built-in buffer size
...
#define FMSTR_ISR_CALLBACK     TSS_FmstrIsrCallback
