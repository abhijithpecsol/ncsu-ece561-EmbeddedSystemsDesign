...
int pll_init(unsigned char, unsigned char, int, unsigned char, unsigned char, unsigned char, signed char, signed char, unsigned char);
...
#define VECTOR_120      isr_default     // 0x0000_01DC 120   104
#define VECTOR_121      isr_default     // 0x0000_01DC 121   105
