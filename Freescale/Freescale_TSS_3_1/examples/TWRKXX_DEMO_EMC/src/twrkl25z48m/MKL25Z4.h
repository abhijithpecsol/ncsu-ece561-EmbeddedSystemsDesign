...
typedef struct MTB_MemMap {
  ...
  uint32_t AUTHSTAT;                               /**< Lock Status Register, offset: 0xFB8 */
...
typedef struct MTBDWT_MemMap {
  ...
  uint32_t CTRL;                                   /**< MTB DWT Control Register, offset: 0x1000 */
  uint8_t RESERVED_1[28];
  struct {                                         /* offset: 0x1020, array step: 0x10 */
    uint32_t COMP;                                   /**< MTB_DWT Comparator Register, array offset: 0x1020, array step: 0x10 */
    uint32_t MASK;                                   /**< MTB_DWT Comparator Mask Register, array offset: 0x1024, array step: 0x10 */
    uint32_t FCT;                                    /**< MTB_DWT Comparator Function Register 0..MTB_DWT Comparator Function Register 1, array offset: 0x1028, array step: 0x10 */
    uint8_t RESERVED_0[4];
  } COMPARATOR[2];
  uint8_t RESERVED_2[448];
  uint32_t TBCTRL;                                 /**< MTB_DWT Trace Buffer Control Register, offset: 0x1200 */
  uint8_t RESERVED_3[3524];
  uint32_t DEVICECFG;                              /**< Device Configuration Register, offset: 0x1FC8 */
  uint32_t DEVICETYPID;                            /**< Device Type Identifier Register, offset: 0x1FCC */
  uint32_t PERIPHID[8];                            /**< Peripheral ID Register, array offset: 0x1FD0, array step: 0x4 */
  uint32_t COMPID[4];                              /**< Component ID Register, array offset: 0x1FF0, array step: 0x4 */
...
typedef struct ROM_MemMap {
  ...
  uint32_t ENTRY[3];                               /**< Entry, array offset: 0x2000, array step: 0x4 */
  uint32_t TABLEMARK;                              /**< End of Table Marker Register, offset: 0x200C */
  uint8_t RESERVED_1[4032];
  uint32_t PERIPHID4;                              /**< Peripheral ID Register, offset: 0x2FD0 */
  uint32_t PERIPHID5;                              /**< Peripheral ID Register, offset: 0x2FD4 */
  uint32_t PERIPHID6;                              /**< Peripheral ID Register, offset: 0x2FD8 */
  uint32_t PERIPHID7;                              /**< Peripheral ID Register, offset: 0x2FDC */
  uint32_t PERIPHID0;                              /**< Peripheral ID Register, offset: 0x2FE0 */
  uint32_t PERIPHID1;                              /**< Peripheral ID Register, offset: 0x2FE4 */
  uint32_t PERIPHID2;                              /**< Peripheral ID Register, offset: 0x2FE8 */
  uint32_t PERIPHID3;                              /**< Peripheral ID Register, offset: 0x2FEC */
  uint32_t COMPID[4];                              /**< Component ID Register, array offset: 0x2FF0, array step: 0x4 */
