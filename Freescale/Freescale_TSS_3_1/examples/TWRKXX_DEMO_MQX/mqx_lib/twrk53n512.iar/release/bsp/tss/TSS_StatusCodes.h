...
***********************************************************************************************************************/
  ...
  #define TSS_DECODER_STATUS_ENABLED              0x03u   /* Return values from Decoder function */
  #define TSS_DECODER_STATUS_ANALOG_USED          0x04u   /* Return values from Decoder function */
  ...
  #define TSS_KEYDETECT_STATUS_PROXIMITY_DONE     0x80u   /* Return value from the KeyDetector function */
  ...
  #define TSS_ERROR_KEYPAD_ILLEGAL_VALUE          0x14u   /* Return values from the KeyPadConfig function */
  #define TSS_ERROR_KEYPAD_OUT_OF_RANGE           0x15u   /* Return values from the KeyPadConfig function */
  #define TSS_ERROR_KEYPAD_ILLEGAL_CONTROL_TYPE   0x16u   /* Return values from the KeyPadConfig function */
  ...
  #define TSS_ERROR_SLIDER_ILLEGAL_VALUE          0x24u   /* Return values from the TSS_SliderConfig function */
  #define TSS_ERROR_SLIDER_OUT_OF_RANGE           0x25u   /* Return values from the TSS_SliderConfig function */
  #define TSS_ERROR_SLIDER_ILLEGAL_CONTROL_TYPE   0x26u   /* Return values from the TSS_SliderConfig function */
  ...
  #define TSS_ERROR_ASLIDER_ILLEGAL_VALUE         0x34u   /* Return values from the TSS_ASliderConfig function */
  ...
  #define TSS_ERROR_MATRIX_ILLEGAL_VALUE          0x44u   /* Return values from the TSS_MatrixConfig function */
