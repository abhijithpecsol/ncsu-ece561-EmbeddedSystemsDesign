...
/*
 ...
 __declspec(weak) vectorTableEntryType vector_73  @(GetIntVectAddr(VReserved73)) = VECTOR_073;
 ...
 __declspec(weak) vectorTableEntryType vector_88  @(GetIntVectAddr(VReserved88)) = VECTOR_088;
 __declspec(weak) vectorTableEntryType vector_89  @(GetIntVectAddr(VReserved89)) = VECTOR_089;
 ...
 __declspec(weak) vectorTableEntryType vector_111 @(GetIntVectAddr(VReserved111)) = VECTOR_111;
