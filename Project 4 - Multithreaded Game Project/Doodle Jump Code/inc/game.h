...
#define MIN_HEIGHT_DIFFERENCE (75)
#define MIN_SIDE_THRESHOLD (5)
...
void Delete_Platform(PLATFORM_T * p);									// Removes a platform from existence. Being a FIFO, this removes every platform created before this platform.
void Generate_Platform(void);													// Generates a new platform a set height above the current highest one
